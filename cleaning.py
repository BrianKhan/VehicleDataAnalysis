...
fil = open("NYPD_Motor_Vehicle_Collisions_Filtered_3vtypemin_unspecUnallowed_yearsremoved.csv", 'r')
read = csv.reader(fil)
data= list(read)
...
#writing out
fil = open("NYPD_Motor_Vehicle_Collisions_Filtered_3vtypemin_unspecUnallowed_yearsremoved_CLEANED.csv", "w")
